  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="img/org.jpg" width=90 height=70 alt="User Image">
        <div>
          <p class="app-sidebar__user-name">César Castro</p>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Sair</span></a>
          <ul class="treeview-menu">
